    ...
    <div class="quadrado-us ">
      ...
      <div class="about-prueba">
        <div id="div1" class="div-perfil" ondrop="drop(event)" ondragover="allowDrop(event)">
          <img id="foto1"  type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" src="img/xavi-serio.jpg" class="about-imgL" draggable="true" ondragstart="drag(event)" id="drag1"></img>
          <audio>
        ...
        <div class="div-perfil" id="div2" ondrop="drop(event)" ondragover="allowDrop(event)">
          <img id="foto2"  draggable="true" data-bs-toggle="modal" data-bs-target="#exampleModal2" ondragstart="drag(event)" id="drag2" class="about-imgR" src="img/joel-serio.jpg"></img>
          <audio>
...
<script type="text/javascript">
  ...
  prevBtn.addEvent  Listener("click", function () {
    cur = (cur - 1 >= 0) ? cur - 1 : max
    playVideos()
  })

  nextBtn.addEventListener("click", function () {
    cur = (cur + 1 < max) ? c  ur + 1 : 0
    playVideos()
  })
